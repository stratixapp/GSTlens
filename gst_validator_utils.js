...
const GSTValidatorUtils = (() => {
  ...
  function validateDate(dateStr) {
    ...
    // Warn if older than 18 months (correct GST ITC deadline per Section 16(4))
    const cutoffDate = new Date();
    cutoffDate.setMonth(cutoffDate.getMonth() - 18);
    if (date < cutoffDate) {
      return { valid: true, warning: `Invoice date ${dateStr} is more than 18 months old — ITC claim deadline (Section 16(4)) may have lapsed` };
    }
